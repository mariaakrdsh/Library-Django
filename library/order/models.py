...
class Order(models.Model):
    """
       ...
       """
    book = models.ForeignKey(Book, on_delete=models.CASCADE, default=None, verbose_name="Book Name")
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, default=None)
    created_at = models.DateTimeField(auto_now_add=True)
    end_at = models.DateTimeField(default=None, null=True, blank=True)
    plated_end_at = models.DateTimeField(auto_now=datetime.datetime.now())
    ...
    def __str__(self):
        ...
        if self.end_at == None:
            ...
            return f"\'id\': {self.pk}, " \
                   ...
                   f" \'end_at\': \'{self.end_at}\'," \
                   f" \'plated_end_at\': \'{self.plated_end_at}\'"
        # return f"Order ID: {self.id} | User: {self.user.first_name} {self.user.last_name} | Book: {self.book.name}"
